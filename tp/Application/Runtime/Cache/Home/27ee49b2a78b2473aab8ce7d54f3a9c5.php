			...
			<a href="#" class="navicon"></a>
				<div class="toggle">
					<ul class="toggle-menu">
						...
						<li><a  href="sign%20in.htmlml">sign in</a></li>
	...
	<div class="container">
		<div class="menu-top">
		  <div class="col-md-4 menu-left">
			  ...
			  <span>There you can browse and search for recipes</span></div>
...
<!--footer-->
	<div class="footer">
		<div class="container">
			...
			</div><p class="footer-class animated wow bounce" data-wow-duration="1000ms" data-wow-delay="500ms">Copyright &copy; 2016.xwxhy.com All rights reserved.</p>
		</div>
	</div>		
	<!--//footer-->
