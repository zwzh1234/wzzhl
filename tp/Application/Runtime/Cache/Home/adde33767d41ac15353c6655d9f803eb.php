...
<head>
<title>Upload</title>
<link href="/tp/Public/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="/tp/Public/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<!--theme-style-->
<link href="/tp/Public/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!--//theme-style-->
...
<link href="/tp/Public/css/styles.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="/tp/Public/css/component.css" />
	<!-- animation-effect -->
<link href="/tp/Public/css/animate.min.css" rel="stylesheet">
<script src="/tp/Public/js/wow.min.js"></script>
<script>
 new WOW().init();
</script>
<!-- //animation-effect -->
...
<div class="header head">
	...
	<div class="menu-top">
				<div class="col-md-4 menu-left animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
					...
					<span>There you can upload some menus</span>
				</div>
				<div class="col-md-8 menu-right animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
					<p>The recipe is cook using a variety of cooking materials, cooking methods through various cooking techniques to create a food product. In modern restaurants, businesses are used to introduce their own dishes of the booklet, which with dishes, price and profile information.
The "menu" from the Latin word, meaning "instructions, this is the chef Memo" in order to record the memo list. Modern restaurant menu, not only to the chef to see, but also to the guests to see. We can sum up in one sentence: "the menu is the product catalog and the introduction of the restaurant. It is the restaurant's consumer guide, but also the most important business card.</p>
				</div>
				<div class="clearfix"> </div>
			</div>
